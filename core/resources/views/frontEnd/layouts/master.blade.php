...
<body
    class="dir-{{ @Helper::currentLanguage()->direction }} lang-{{ @Helper::currentLanguage()->code }} {{ !Helper::GeneralSiteSettings('style_change') && Helper::GeneralSiteSettings('style_type') ? 'dark' : '' }}">
