                        ...
                        <div class="col-md-12 col-xl-4">
                            <div class="box" style="min-height: 300px">
                                ...
                                @if($TodayByBrowser1_val >0)
                                        <?php
                                        $perc1 = round(($TodayByBrowser1_val * 100) / ($TodayByBrowser1_val + $TodayByBrowser2_val));
                                        $perc2 = round(($TodayByBrowser2_val * 100) / ($TodayByBrowser1_val + $TodayByBrowser2_val));
                                        ?>
                                            ...
                                            <div class="row-cell p-a">
                                                <div class="inline m-b">
                                                    <div ui-jp="easyPieChart" class="easyPieChart"
                                                         ...
                                                         data-redraw='true' data-percent="{{ $perc1 }}" ui-options="{
	                      lineWidth: 8,
	                      ...
	                      animate:{
	                        ...
	                        enabled:true
                                                ...
                                                <div>
                                                    {{$TodayByBrowser1}}
                                                    <strong class="block m-b-sm">{{$TodayByBrowser1_val}}</strong>
                                            ...
                                            <div class="row-cell p-a dker">
                                                <div class="inline m-b">
                                                    <div ui-jp="easyPieChart" class="easyPieChart"
                                                         ui-refresh="app.setting.color"
                                                         data-redraw='true' data-percent="{{ $perc2 }}" ui-options="{
	                      lineWidth: 8,
	                      trackColor: 'rgba(0,0,0,0.05)',
	                      barColor: '#fcc100',
	                      scaleColor: 'transparent',
	                      ...
	                      animate:{
	                        ...
	                        enabled:true
                                                ...
                                                <div>
                                                    {{$TodayByBrowser2}}
                                                    <strong class="block m-b-sm">{{$TodayByBrowser2_val}}</strong>
                                                    <a href="{{ route('analytics', 'browser') }}"
                                                       class="btn btn-sm white text-u-c rounded">{{ __('backend.more') }}</a>
                                                </div>
                                            </div>
                ...
                <div class="row">
                    ...
                    @if(Helper::GeneralWebmasterSettings("newsletter_status"))
	                	...
	                	<span class="w-40 avatar">
                            @if($Contact->photo!="")
                                <img src="{{ route("fileView",["path" =>'contacts/'.$Contact->photo ]) }}"
                                     alt="{{ $Contact->first_name }} {{ $Contact->last_name }}">
                            @else
                                <img src="{{ route("fileView",["path" =>'contacts/profile.jpg' ]) }}"
