                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="btn-group pull-right">
                                <form method="POST" action="{{ route("visitorsSearch") }}" class="dashboard-form">
                                    @csrf
                                    <div class="input-group input-group-sm">
                                        <input type="text" autocomplete="off" name="ip" id="ip_filter" value="{{ $ip_code }}" required
                                               placeholder="{{ __('backend.ip')."..." }}" class="form-control"/>
