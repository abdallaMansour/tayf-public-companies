<div id="add_language" class="modal fade" data-backdrop="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route("webmasterLanguageStore") }}" class="dashboard-form">
                @csrf
                <div class="modal-body p-lg">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" autocomplete="off" name="code" id="lang_code" value="" required maxlength="2" minlength="2" onkeyup="this.value=this.value.replace(/[^a-z]/g,'');" placeholder="en" class="form-control" style="text-transform: lowercase" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lang_title"
                               class="col-sm-3 form-control-label">{{ __('backend.languageTitle') }}</label>
                        <div class="col-sm-9">
                            <input type="text" autocomplete="off" name="title" id="lang_title" value="" required placeholder="English" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="name"
        ...
        <div id="edit_language_{{ $Language->id }}" class="modal fade" data-backdrop="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route("webmasterLanguageUpdate") }}" class="dashboard-form">
                        @csrf
                        <div class="modal-body p-lg">
                            <div class="form-group row">
                                <label for="edit_lang_code"
                                       class="col-sm-3 form-control-label">{{ __('backend.languageCode') }}</label>
                                <div class="col-sm-9">
                                    <input type="text" autocomplete="off" name="code" id="edit_lang_code" value="{{ $Language->code }}" readonly maxlength="2" minlength="2" onkeyup="this.value=this.value.replace(/[^a-z]/g,'');" placeholder="en" class="form-control" style="text-transform: lowercase" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="edit_lang_title"
                                       class="col-sm-3 form-control-label">{{ __('backend.languageTitle') }}</label>
                                <div class="col-sm-9">
                                    <input type="text" autocomplete="off" name="title" id="edit_lang_title" value="{{ $Language->title }}" required placeholder="English" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name"
