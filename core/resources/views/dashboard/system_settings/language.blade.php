...
<div class="tab-pane {{  ( Session::get('active_tab') == 'languageSettingsTab') ? 'active' : '' }}"
    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="m-t-2">
            ...
            <div>
                <a href="https://smartend.app/docs/system-settings-and-configuration/managing-languages-and-translations"
                   class="btn white dk w-full" target="_blank"><i class="fa fa-support"></i> {!!  __('backend.languagesGuide') !!}</a>
            </div>
        </div>
    </div>
</div>
