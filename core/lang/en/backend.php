...
return array(
    ...
    'domainRequestAlreadyExists' => 'You have already submitted a domain request. Only one request is allowed per user.',
    'newDomainRequest' => 'New Domain Request',
    'domain' => 'Domain',
    'submitRequest' => 'Submit Request',
    'yourDomainRequest' => 'Your Domain Request',
    'active' => 'Active',
    'pending' => 'Pending',
    'inactive' => 'Inactive',
    'status' => 'Status',
    'howToConnectYourDomain' => 'How to Connect Your Domain',
    'changeNameServerRecords' => 'Change the name server records on your domain provider\'s site.',
    'loginToGoDaddy' => 'Log in to your GoDaddy account',
    'goToDomainManagement' => 'Go to your domain\'s management page and find the name servers (or custom name servers).',
    'deleteNameServerRecords' => 'Delete the name server records that are there and paste the following name servers records:',
    'domainConnectionNote' => 'Connecting your domain might take up to 24 hours. Custom DNS settings like email or other services may stop working unless you add them again in Hostinger.',
    'note' => 'Note',
