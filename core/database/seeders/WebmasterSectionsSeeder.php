...
class WebmasterSectionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $section->type = 10; // 10 = Landing pages


        $section->title_status = 1;
        $section->case_status = 1;
        $section->seo_status = 1;
        $section->no_status = 1;
        $section->photo_status = 1;
        $section->visits_status = 1;
        $section->featured_status = 1;
        $section->index_status = 1;
        $section->tags_status = 1;
        $section->code_status = 1;
